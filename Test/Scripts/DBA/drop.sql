REVOKE SELECT ON CALL_LOG FROM FTEST;
REVOKE SELECT ON CHECK_TABLE FROM FTEST;

REVOKE INSERT,SELECT ON DATES FROM FTEST;

REVOKE EXECUTE ON log_in FROM FTEST;
REVOKE EXECUTE ON log_out FROM FTEST;
REVOKE EXECUTE ON INSERT_TO_CALL_LOG FROM FTEST;
REVOKE EXECUTE ON GET_NUMBER_TYPE FROM FTEST;
